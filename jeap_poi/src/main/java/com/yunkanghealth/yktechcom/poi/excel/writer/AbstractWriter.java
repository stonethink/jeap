package com.yunkanghealth.yktechcom.poi.excel.writer;
...
public abstract class AbstractWriter implements IWriter {
	...
	public void writeFormula(String formulaStr) {
		if (JeapStringUtil.isEmpty(formulaStr)) {
			return;
		}
		try {
	...
	public void writeComment(String commentStr) {
		if (JeapStringUtil.isEmpty(commentStr)) {
			return;
		}
		...
		comment.setAuthor("Jeap POI");
		cell.setCellComment(comment);
	}

	@Override
	public void writeHyperlink(int linkType, String linkAddress) {
